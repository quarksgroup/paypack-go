...
func New(uri, callback string) (*paypack.Client, error) {
...
// NewDefault returns a new PAYPACK-PAYMENTS paypack client using the`
// default "https://payments.paypack.rw/api" address.
func NewDefault(callback string) *paypack.Client {
	client, _ := New(baseURL, callback)
	return client
}
